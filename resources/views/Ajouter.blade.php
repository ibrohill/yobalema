...
@section('titre','Ajout de voiture')
        ...
        <div class="col-lg-6">
            <div class="card shadow-lg border-white" style="background-color: #fff;">
                <div class="card-header bg-primary text-white">
                    <h3 class="m-0">Ajouter une voiture</h3>
                </div>
                <div class="card-body">
                    @if (session('status'))
                    ...
                    <form action="/ajouter/traitement" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="categorie" id="categorie" required>
                                <option value="voiture">Voiture Pickup</option>
                                <option value="pickup">Voiture Compacte</option>
                                <option value="autre">Voiture Berline</option>
                            </select>
                        </div>
                        <div class="mb-3">
